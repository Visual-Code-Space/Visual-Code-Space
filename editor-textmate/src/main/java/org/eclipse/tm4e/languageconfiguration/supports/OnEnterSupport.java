 ...
 *
 * @see <a
 *     href="https://github.com/microsoft/vscode/blob/main/src/vs/editor/common/languages/supports/onEnter.ts">
...
public class OnEnterSupport {
  ...
  public OnEnterSupport(
      @Nullable final List<CharacterPair> brackets, @Nullable final List<OnEnterRule> regExpRules) {
    this.brackets =
  ...
  private static final class ProcessedBracketPair {
    ...
    @Nullable private final Pattern openRegExp;

    @Nullable private final Pattern closeRegExp;
