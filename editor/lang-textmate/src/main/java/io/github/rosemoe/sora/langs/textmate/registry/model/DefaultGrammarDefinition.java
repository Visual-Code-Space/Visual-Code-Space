...
public class DefaultGrammarDefinition implements GrammarDefinition {
  ...
  private DefaultGrammarDefinition(
      String name,
      String scopeName,
      IGrammarSource grammarSource,
      String languageConfigurationPath) {
  ...
  private DefaultGrammarDefinition(
      ...
      IGrammarSource grammarSource,
      String languageConfigurationPath,
      Map<String, String> embeddedLanguages) {
  ...
  public GrammarDefinition withEmbeddedLanguages(Map<String, String> embeddedLanguages) {
    ...
    return new DefaultGrammarDefinition(
        this.name,
        this.scopeName,
        this.grammarSource,
        this.languageConfigurationPath,
        embeddedLanguages);
  }
  ...
  public static DefaultGrammarDefinition withLanguageConfiguration(
  ...
  public static DefaultGrammarDefinition withLanguageConfiguration(
      ...
      String scopeName) {
    return new DefaultGrammarDefinition(
        languageName, scopeName, grammarSource, languageConfigurationPath);
  }

  public static DefaultGrammarDefinition withGrammarSource(
      IGrammarSource grammarSource, String languageName, String scopeName) {
