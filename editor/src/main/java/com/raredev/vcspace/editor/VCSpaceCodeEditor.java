...
import com.raredev.vcspace.editor.ace.callback.event.OnContentChangeEventCallback;
import com.raredev.vcspace.editor.ace.options.EditorOptions;

public class VCSpaceCodeEditor extends WebView {
  ...
  private OnContentChangeEventCallback onContentChangeEventCallback;

  public VCSpaceCodeEditor(Context context) {
    this(context, null);
  }

  public VCSpaceCodeEditor(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public VCSpaceCodeEditor(Context context, AttributeSet attrs, int defStyleAttr) {
    this(context, attrs, defStyleAttr, 0);
  }

  public VCSpaceCodeEditor(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    addJavascriptInterface(new VCSpaceWebInterface(this), "VCSpace");
  ...
  public void getText(OnJsReturnValueCallback callback) {
    loadJs("editor.session.getValue()", callback);
  }
  ...
  public OnContentChangeEventCallback getOnContentChangeEventCallback() {
    return this.onContentChangeEventCallback;
  }

  public void setOnContentChangeEventCallback(
      OnContentChangeEventCallback onContentChangeEventCallback) {
    this.onContentChangeEventCallback = onContentChangeEventCallback;
  }
}
