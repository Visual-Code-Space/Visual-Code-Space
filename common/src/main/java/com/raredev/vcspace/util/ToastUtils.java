...
public class ToastUtils {
  ...
  private static View createToastView(CharSequence message, int type) {
    ...
    tv.setTextColor(MaterialColors.getColor(Utils.getContext(), com.google.android.material.R.attr.colorOnSurface, 0));
    tv.setText(message);

    GradientDrawable drawable = new GradientDrawable();
    drawable.setShape(GradientDrawable.RECTANGLE);
    drawable.setCornerRadius(Utils.pxToDp(15));
    drawable.setColor(MaterialColors.getColor(Utils.getContext(), com.google.android.material.R.attr.colorSurface, 0));
    drawable.setStroke(1, MaterialColors.getColor(Utils.getContext(), com.google.android.material.R.attr.colorOutline, 0));
