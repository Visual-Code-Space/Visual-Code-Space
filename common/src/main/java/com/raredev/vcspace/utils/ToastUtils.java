...
public class ToastUtils {
  ...
  public static void showShort(String message, int type) {
    Toast.makeText(BaseApp.getInstance().getApplicationContext(), message, Toast.LENGTH_SHORT)
        .show();
  }

  public static void showLong(CharSequence message, int type) {
    Toast.makeText(BaseApp.getInstance().getApplicationContext(), message, Toast.LENGTH_LONG)
        .show();
  }
}
