...
public class TMTokenization implements ITokenizationSupport {
  ...
  public TokenizationResult tokenize(
    ...
    return new TokenizationResult(
        ...
        // TODO Math.min() is a temporary workaround because currently in some cases
  ...
  private static final class DecodeMap {
    ...
    private final Map<String /* scope */, Integer @Nullable [] /* ids */> scopeToTokenIds =
        new LinkedHashMap<>();
    private final Map<String /* token */, @Nullable Integer /* id */> tokenToTokenId =
        new LinkedHashMap<>();
    private final Map<Integer /* id */, String /* id */> tokenIdToToken = new LinkedHashMap<>();
    TMTokenDecodeData prevToken =
        new TMTokenDecodeData(Collections.emptyList(), new LinkedHashMap<>());
