...
public class EditorOptions {
  ...
  public static EditorOptions getInstance() {
    if (instance == null) {
      ...
      synchronized (EditorOptions.class) {
        ...
        if (instance == null) instance = new EditorOptions();
      }
    }
    return instance;
  }
  ...
  public boolean showLineNumbers = PreferencesUtils.INSTANCE.getLineNumbers();
  ...
  public boolean useSoftTabs = PreferencesUtils.INSTANCE.getUseTab();
  public boolean enableEmmet = false;
  public boolean useElasticTabstops = false;

  public int firstLineNumber = 1;
  public int fontSize = PreferencesUtils.INSTANCE.getTextSize();
  public int printMarginColumn = 80;
  public int tabSize = PreferencesUtils.INSTANCE.getTabSize();
