...
fun PluginTabs(
  ...
  val tabItems = listOf(PluginScreens.Explore, PluginScreens.Installed)
  val tabIndices = mapOf(PluginScreens.Explore.route to 0, PluginScreens.Installed.route to 1)
