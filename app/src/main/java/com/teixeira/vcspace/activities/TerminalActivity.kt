          ...
          if (!outputFile.exists()) {
            ...
            downloadFile(
              ...
              onProgress = { downloadedBytes, totalBytes ->
                val currentFileProgress = downloadedBytes.toFloat() / totalBytes.toFloat()
...
private const val aarch64_packages = "https://github.com/itsvks19/vcspace-packages/raw/refs/heads/main/aarch64/usr.tar.gz"
private const val arm_packages = "https://github.com/itsvks19/vcspace-packages/raw/refs/heads/main/arm/usr.tar.gz"
private const val x86_64_packages = "https://github.com/itsvks19/vcspace-packages/raw/refs/heads/main/x86_64/usr.tar.gz"
