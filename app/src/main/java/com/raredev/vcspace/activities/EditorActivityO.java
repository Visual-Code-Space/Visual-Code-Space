  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (editorPanel != null) {
      ...
      if (id == R.id.back) {
        ...
        else ToastUtilsKt.showAlertToast(this, "Can't go back...");
      } else if (id == R.id.forward) {
        if (webView.canGoForward()) webView.goForward();
        else ToastUtilsKt.showAlertToast(this, "Can't go forward...");
